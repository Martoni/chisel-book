...
% pour avoir les caractères français
...
\ \\
\vspace{1cm}
{\usekomafont{title}\mdseries\huge La conception numérique avec Chisel}
\cleardoublepage
\end{flushleft}
\newpage
...
\ \\
\vspace{1cm}
{\usekomafont{title}\Huge La conception numérique avec Chisel\\
\bigskip
\bigskip
\bigskip
\bigskip
...
Ce livre est une introduction à la conception numérique ce concentrant sur le
langage de description matériel Chisel. Chisel est un nouveau langage de
description matériel (HDL pour Hardware Description Language) qui permet
d'apporter la programmation objet et fonctionnelle dans le monde de la
...
Ce livre s'adresse aux ingénieurs en électronique autant qu'aux ingénieurs en
informatique. Les ingénieurs en électronique qui connaissent déjà le Verilog
et/ou le VHDL pourront augmenter leurs productivité avec un langage
informatique moderne (basé sur le Scala) pour leur prochain projet en FPGA ou
ASIC. Les ingénieurs en informatique pourront tirer parti de leurs
connaissances en programmation objets et fonctionnelles pour concevoir du
matériel, et utiliser – par exemple – des accélérateurs FPGA dans le «nuage».
...
Ce livre explore de petites et moyenne architectures numérique en Chisel.
